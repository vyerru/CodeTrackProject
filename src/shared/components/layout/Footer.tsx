    ...
    <footer className="bg-card border-t border-border">
        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <button onClick={() => navigate('/courses')} className="text-muted-foreground hover:text-foreground transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 outline-none">
                  Courses
                </button>
              </li>
              <li>
                <button onClick={() => navigate('/articles')} className="text-muted-foreground hover:text-foreground transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 outline-none">
                  Artikel
                </button>
              </li>
              <li>
                <button onClick={() => navigate('#')} className="text-muted-foreground hover:text-foreground transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 outline-none">
                  Komunitas
                </button>
              </li>
            </ul>
      ...
      <div className="border-t border-border">
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">&copy; {new Date().getFullYear()} CodeTrack. All rights reserved.</p>
...
function SocialButton({ children, href, target }: { children: React.ReactNode; href: string; target?: string }) {
  return (
    <a
      ...
      className="w-10 h-10 bg-muted rounded-lg flex items-center justify-center hover:bg-primary transition-all focus-visible:ring-2 focus-visible:ring-indigo-500 outline-none"
    >
      {children}
    </a>
  )
