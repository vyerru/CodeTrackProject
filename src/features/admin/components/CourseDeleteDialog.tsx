...
export default function CourseDeleteDialog({ course, loading, onConfirm, onCancel }: Props) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" onClick={onCancel}>
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-6" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="text-sm text-gray-600 mb-1">Apakah Anda yakin ingin menghapus course berikut?</p>
        <p className="text-sm font-medium text-gray-900 mb-6 bg-gray-50 rounded-lg p-3">&ldquo;{course.title}&rdquo;</p>
